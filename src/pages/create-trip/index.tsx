import { ArrowRight, MapPin, Calendar, UserRoundPlus, Settings2, X, User, Mail } from 'lucide-react'
        ...
        <div className='fixed inset-0 bg-black/60 flex items-center justify-center'>
          <div className='w-[640px] rounded-lg py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
            ...
            <form onSubmit={addNewEmailToInvite} className='space-y-3'>
              ...
              <button onClick={createTrip} type='submit' className='bg-lime-300 w-full text-lime-950 justify-center rounded-lg px-5 h-11 font-medium flex items-center gap-2 hover:bg-lime-400'>
